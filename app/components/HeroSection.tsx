  ...
  return (
    <section className="relative">
      <div className="relative lg:h-[700px] h-[450px]">
        ...
        <div className="absolute bg-[#FFCA3B] lg:w-[180px] lg:h-[180px] w-36 h-36 rounded-2xl flex flex-col justify-center items-center lg:bottom-12 lg:right-48 right-24 bottom-6 z-20">
